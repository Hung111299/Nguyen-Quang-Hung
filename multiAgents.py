...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        newPos = successorGameState.getPacmanPosition() #vitripacmanmoi dang(x,y)
        newFood = successorGameState.getFood() #vitrithucan (x,y)
        newGhostStates = successorGameState.getGhostStates() #vitricacconma (x,y)
        newScaredTimes = [ghostState.scaredTimer for ghostState in newGhostStates] #thoigiancacconmaconso (g)
